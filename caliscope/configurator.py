...
class Configurator:
    ...
    def __init__(self, workspace_path: Path) -> None:
        ...
        if exists(self.config_toml_path):
            ...
            logger.warning("No existing config.toml found; creating starter file with charuco")
    ...
    def get_charuco(self) -> Charuco:
        ...
        charuco = Charuco(
            ...
            rows=params["rows"],
            square_marker_size_mm=params["square_marker_size_mm"],
